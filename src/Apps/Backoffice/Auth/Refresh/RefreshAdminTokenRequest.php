...
use App\Contexts\Backoffice\Auth\Application\RefreshToken\RefreshAdminTokenQuery;
use App\Contexts\Shared\Infrastructure\Symfony\Exception\ValidationException;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Validator\Constraints as Assert;

final readonly class RefreshAdminTokenRequest
{
    ...
    public function toQuery(): RefreshAdminTokenQuery
    {
        return new RefreshAdminTokenQuery($this->refreshToken);
    }
}
