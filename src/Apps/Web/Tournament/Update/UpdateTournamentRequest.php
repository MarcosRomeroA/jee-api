...
final readonly class UpdateTournamentRequest
{
    public function __construct(
        ...
        #[Assert\Type("bool")] public bool $isOfficial = false,
        ...
        #[Assert\NotBlank] #[Assert\Type("string")] public string $startAt = "",

        #[Assert\NotBlank] #[Assert\Type("string")] public string $endAt = "",
    ) {}
