...
final readonly class RestoreUserPasswordCommandHandler implements CommandHandler
{
    public function __construct(
        private UserPasswordRestorer $restorer,
    )
    {
    }
     ...
     */
    public function __invoke(RestoreUserPasswordCommand $command): void
    {
        ...
        $this->restorer->__invoke($id, $newPassword);
    }
}