...
use App\Contexts\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegister;
...
final class DoctrineEntityManagerFactory
{
    private static array $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'App\Contexts\Shared\Domain',
    ];
