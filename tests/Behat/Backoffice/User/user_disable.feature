Feature: Disable user from backoffice
  ...
  Scenario: Successfully disable a user
    ...
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440001/disable"
  ...
  Scenario: Disabled user cannot login
    ...
    And I am authenticated as admin with user "admin" and password "admin"
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440002/disable"
    Then the response status code should be 200
  ...
  Scenario: Non-admin cannot disable users
    ...
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440005/disable"
    Then the response status code should be 401

  @backoffice @user
  Scenario: Disable non-existent user returns 404
    Given I am authenticated as admin with user "admin" and password "admin"
    When I send a POST request to "/backoffice/user/999e8400-e29b-41d4-a716-446655440999/disable"
