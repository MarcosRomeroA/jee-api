Feature: Enable user from backoffice
  ...
  Scenario: Successfully enable a disabled user
    ...
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440010/disable"
    Then the response status code should be 200
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440010/enable"
    Then the response status code should be 200
  ...
  Scenario: Enabled user can login again
    ...
    And I am authenticated as admin with user "admin" and password "admin"
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440011/disable"
    Then the response status code should be 200
    ...
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440011/enable"
    Then the response status code should be 200
    When I send a POST request to "/api/login" with body:
      """
      {
  ...
  Scenario: Enabled user can access protected endpoints
    ...
    And I am authenticated as admin with user "admin" and password "admin"
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440012/disable"
    Then the response status code should be 200
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440012/enable"
    Then the response status code should be 200
  ...
  Scenario: Non-admin cannot enable users
    ...
    And I am authenticated as admin with user "admin" and password "admin"
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440014/disable"
    Then the response status code should be 200
    Given I am authenticated as "alice@test.com" with password "pass123"
    When I send a POST request to "/backoffice/user/850e8400-e29b-41d4-a716-446655440014/enable"
    Then the response status code should be 401

  @backoffice @user
  Scenario: Enable non-existent user returns 404
    Given I am authenticated as admin with user "admin" and password "admin"
    When I send a POST request to "/backoffice/user/999e8400-e29b-41d4-a716-446655440999/enable"
